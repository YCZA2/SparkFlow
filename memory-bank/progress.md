...
| 阶段 8-10 | 口播稿生成、提词器与拍摄 | 进行中 | 60% | [查看详情](progress-phase-8-10.md) |
...
- **阶段 8**: 口播稿生成功能（进行中）
  ...
  - ✅ 8.4 口播稿列表 API
  - ✅ 8.5 口播稿详情 API
  - ✅ 8.6 前端碎片多选与“交给 AI 编导”按钮（待验证）
  - ✅ 8.7 前端 AI 生成页与生成后跳转详情页（待验证）
  - ✅ 9.1 口播稿详情页“一键去拍摄”按钮 + 参数透传到 `/shoot`（待验证）
  - ✅ 9.2 提词器滚动组件（自动滚动/暂停继续/拖动进度/字号调节）（待验证）
