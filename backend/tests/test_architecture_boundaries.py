...
def test_shared_infrastructure_is_split_into_focused_modules() -> None:
    ...
    expected_files = [
        BACKEND_ROOT / "modules" / "shared" / "infrastructure" / "storage.py",
        BACKEND_ROOT / "modules" / "shared" / "infrastructure" / "vector_store.py",
        BACKEND_ROOT / "modules" / "shared" / "infrastructure" / "providers.py",
    ]
