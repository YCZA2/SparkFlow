...
os.environ.setdefault("BACKEND_LOG_PATH", os.path.join(TEST_RUNTIME_LOG_DIR, "backend", "backend.log"))
os.environ.setdefault("BACKEND_ERROR_LOG_PATH", os.path.join(TEST_RUNTIME_LOG_DIR, "backend", "backend-error.log"))
os.environ.setdefault("ACCESS_LOG_PATH", os.path.join(TEST_RUNTIME_LOG_DIR, "access", "access.log"))
os.environ.setdefault("ACCESS_ERROR_LOG_PATH", os.path.join(TEST_RUNTIME_LOG_DIR, "access", "access-error.log"))
os.environ.setdefault("MOBILE_DEBUG_LOG_PATH", os.path.join(TEST_RUNTIME_LOG_DIR, "mobile", "mobile-debug.log"))
