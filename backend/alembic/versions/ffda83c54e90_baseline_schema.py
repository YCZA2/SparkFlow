...
Revision ID: ffda83c54e90
Revises: 
Create Date: 2026-03-28 22:49:55.278204
...
def upgrade() -> None:
    """Upgrade schema."""
    # 基线迁移直接创建当前后端 PostgreSQL 所需的完整表结构。
    ...
    op.create_table('backup_restore_sessions',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('user_id', sa.String(), nullable=False),
    ...
    op.create_index('ix_backup_restore_sessions_user_id_created_at', 'backup_restore_sessions', ['user_id', 'created_at'], unique=False)
    ...
    op.create_table('methodology_entries',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('user_id', sa.String(), nullable=False),
    ...
    op.create_index('ix_methodology_entries_user_id_enabled_updated_at', 'methodology_entries', ['user_id', 'enabled', 'updated_at'], unique=False)
    ...
    op.create_table('stable_core_profiles',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('user_id', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    ...
    op.create_index('ix_stable_core_profiles_user_id_updated_at', 'stable_core_profiles', ['user_id', 'updated_at'], unique=False)
    ...
    op.create_table('fragment_blocks',
    sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_index('ix_fragment_blocks_fragment_id_order_index', 'fragment_blocks', ['fragment_id', 'order_index'], unique=False)
