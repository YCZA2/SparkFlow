...
export async function mapLocalEntityRowToFragment(
  ...
  return {
    ...
    media_task_run_id: row.mediaTaskRunId ?? null,
    media_task_status: (row.mediaTaskStatus as Fragment['media_task_status']) ?? null,
    media_task_error_message: row.mediaTaskErrorMessage ?? null,
