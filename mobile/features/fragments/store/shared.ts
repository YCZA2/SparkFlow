...
export async function mapLocalEntityRowToFragment(
  ...
  return {
    ...
    media_pipeline_run_id: row.mediaPipelineRunId ?? null,
    media_pipeline_status: (row.mediaPipelineStatus as Fragment['media_pipeline_status']) ?? null,
    media_pipeline_error_message: row.mediaPipelineErrorMessage ?? null,
