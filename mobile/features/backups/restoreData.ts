    ...
    if (plan.fragments.length > 0) {
      await tx.insert(fragmentsTable).values(
        plan.fragments.map((fragment) => ({
          ...
          systemPurpose: fragment.systemPurpose,
          userPurpose: fragment.userPurpose,
          systemTagsJson: fragment.systemTagsJson,
          userTagsJson: fragment.userTagsJson,
          dismissedSystemTagsJson: fragment.dismissedSystemTagsJson,
