...
export const fragmentsTable = sqliteTable('fragments', {
  ...
  userPurpose: text('user_purpose'),
  systemTagsJson: text('system_tags_json').notNull().default('[]'),
  userTagsJson: text('user_tags_json').notNull().default('[]'),
  dismissedSystemTagsJson: text('dismissed_system_tags_json').notNull().default('[]'),
