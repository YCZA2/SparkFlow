...
export const fragmentsTable = sqliteTable('fragments', {
  ...
  mediaPipelineRunId: text('media_pipeline_run_id'),
  mediaPipelineStatus: text('media_pipeline_status'),
  mediaPipelineErrorMessage: text('media_pipeline_error_message'),
